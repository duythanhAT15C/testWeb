...
<body id="top">
	...
	<!-- 
			<div c:if="${not empty msg}" class="toast" data-delay="1000"
	...
	<!-- 
		...
		<script>
			document.addEventListener('DOMContentLoaded', function() {
				Swal.fire({
					title : 'Success!',
					text : '${msg}', // Hiển thị thông báo từ controller
					icon : 'success',
					timer : 3000,
					buttons : true
				});
	...
	<c:if test="${not empty msgDetailId}">
	...
	<div class="site-wrap">
					...
					<div
						...
						<div class="ml-auto">
							<c:if test="${not empty sessionScope.user}">
								...
								<a href="${pageContext.request.contextPath}/public/logout/"
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="mb-5">
							...
							<span>${donationDetail.noidung}</span>
						</div>
						...
						<div class="pt-5">
							...
							<ul class="comment-list" id="comment-list">
								<c:forEach var="donation" items="${list }">
									<c:if
										test="${donation.status != 'Chờ xác nhận' && donation.status != 'Huỷ xác nhận' }">
										<li class="comment">
											<div class="vcard bio">
												<img
											...
											<div class="comment-body">
												<h3>${donation.name}</h3>
												<div class="meta" style="color: #373b3e !important;">${donation.donationDate}</div>
												<p>${donation.formattedMoney }VNĐ</p>
						...
						<div class="bg-light p-3 border rounded mb-4">
							...
							<ul class="list-unstyled pl-3 mb-0">
								<li class="mb-2"><strong class="text-black">Mã đợt
										quyên góp: ${donationDetail.code }</strong></li>
								<li class="mb-2"><strong class="text-black">Tên
										đợt quyên góp: ${donationDetail.name }</strong></li>
								<li class="mb-2"><strong class="text-black">Ngày
										bắt đầu: ${donationDetail.formatStartDate }</strong></li>
								<li class="mb-2"><strong class="text-black">Ngày
										kết thúc: ${donationDetail.formatEndDate }</strong></li>
								<li class="mb-2"><strong class="text-black">Cá
										nhân/Tổ chức: ${donationDetail.tochuc }</strong></li>
								<li class="mb-2"><strong class="text-black">Số
										điện thoại: ${donationDetail.sdt }</strong></li>
								<li class="mb-2"><strong class="text-black">Tổng
										tiền quyên góp nhận được: ${donationDetail.formatMoney } VNĐ</strong></li>
								<li class="mb-2"><strong class="text-black">Trạng
										thái:</strong> <span>${donationDetail.created }</span>
							</ul>
						</div>

						<c:choose>
							<c:when test="${donationDetail.status == 1}">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form:form method="post"
							action="${pageContext.request.contextPath}/public/detail/${donationDetail.id}"
								...
								<div class="row">
									...
									<div class="col-12">
										<label for="addname" class="col-form-label">Họ tên:</label> <input
											...
											góp:</label> <input type="number" class="form-control" placeholder=""
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				var comments = commentList.children(".comment");
				console.log(comments.length)
				if (comments.length > 3) {
					commentList.css({
						"max-height" : "350px", /* Điều chỉnh chiều cao tối đa của danh sách */
						"overflow-y" : "auto" /* Thêm cuộn dọc nếu danh sách vượt quá chiều cao tối đa */
					});
				}
			});
		</script>
